...
# This code only works on my mac for some reason... I think there is a dependecy required but I can't find it on the OpenAI page. -Kabir

# The name of the game to solve
game_name = 'PICK GAME NAME'  # It's in the openAI documentation
...
def get_actions(outputs):
    ...
    for rule in rules:
        ...
        for key in rule:
            ...
            elif len(rule) == 2: # if one key is missing 
                next_action = False
...
my_env.configure(remotes=1)  # create docker, I should fix this because sometimes a error is created here. 
